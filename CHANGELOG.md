...
- Deps: update `@angular/core` to 20.3.21 and `@angular/cli` to 20.3.25.
...
- Translations.
- SSR: pass the configured allowed host list directly to Angular's NgModule renderer for Angular 20.3.21 host validation.
